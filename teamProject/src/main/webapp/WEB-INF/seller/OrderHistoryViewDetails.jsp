                    ...
                    <div class="content-area">
                        ...
                        <div v-else-if="orderDetail" class="detail-card">
                            <div class="order-header">
                                주문 ID: [[ orderDetail.orderId ]] | 주문자: [[ orderDetail.userName ]] | 픽업일: [[
...
<button class="action-button" @click="goToOptionAdd(orderDetail.orderId)">
    옵션 추가
</button>
...
goToOptionAdd(orderId) {
    ...
    location.href = `/seller/order/addOption.do?orderId=${orderId}`;
},
