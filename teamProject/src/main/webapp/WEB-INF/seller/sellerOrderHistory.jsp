        ...
        <head>
            ...
            <style>
                ...
                .content-area {
                    ...
                    /* align-items: center; */
                    /* 이 속성은 개별 요소의 margin: 0 auto; 와 중복될 수 있어 제거 */
                    /* justify-content: flex-start; */
                    /* 이 속성도 제거하고 margin으로 대체 */

                    /* 전체 content-area의 폭을 제한하고 중앙 정렬 */
                    max-width: 12000px;
                    /* 이전 600px -> 900px로 증가 */
                    margin-right: auto;
                    /* margin-left와 함께 중앙 정렬 */
                    margin-left: 220px;
                    /* 사이드바와 겹치지 않게 유지 */
                }
                ...
                .order-card:hover {
                    box-shadow: 0 5px 18px rgba(62, 39, 35, 0.15);
                    /* 호버 그림자 강화 */
                            ...
                            <div v-for="order in pagedOrderList" :key="order.orderId" class="order-card">
                                <div class="order-info-header">
                                    ...
                                    <div class="header-buttons">
                                        <button class="view-detail-button" @click="goDetail(order.orderId)">
                                            주문상세 보기
                                        </button>
                                    </div>
                                </div>
