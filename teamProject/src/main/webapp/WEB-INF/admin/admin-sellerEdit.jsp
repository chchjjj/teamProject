                ...
                <div class="userEdit">
                    ...
                    <table>
                        <tr>
                            <th>사업자 등록증 이미지</th>
                            <td>
                                <div class="registration-image" v-if="seller.imgPath" @click="fnShowImage">
                    ...
                    <!-- 이미지 크게 보기-->
                    <div class="image-modal" :class="{active: showModal}" @click="fnCloseImage">
                    ...
                    <div style="text-align: right; margin-top: 20px;">
                        ...
                        <button @click="fnHead()">사업자번호 조회사이트로</button>
    ...
    <script>
        const app = Vue.createApp({
            ...
            methods: {
                ...
                fnHead(){
                    location.href = "https://moneypin.biz/bizno/";
                },
