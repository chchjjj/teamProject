...
<head>
    ...
    <style>
        ...
        .input-group {
            display: flex; /* 주소 필드와 버튼을 한 줄에 배치 */
            gap: 10px;
        }
        ...
        .form-group input[type="text"].addr-input {
            flex-grow: 1; /* 주소 입력 필드가 공간을 차지하도록 */
        }
            ...
            <form @submit.prevent="nextPage">
                ...
                <div class="form-group" v-if="formData.isChatEnabled === 'Y'">
                    ...
                    <div style="display: flex; align-items: center; gap: 10px;">
                        <input type="time" v-model="formData.chatStart" id="chatStart" required style="flex-grow: 1;">
                        <span>~</span>
                        <input type="time" v-model="formData.chatEnd" id="chatEnd" required style="flex-grow: 1;">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" v-model="formData.storeAddr" id="storeAddr" required readonly class="addr-input" 
                            placeholder="주소 검색 버튼을 눌러 입력하세요">
                        <%-- 🌟 주소 검색 버튼 --%>
                        <button type="button" class="addr-search-btn" @click="fnSearchAddress">주소 검색</button>
                    </div>
                </div>
